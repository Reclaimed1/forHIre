...
export default function Boast() {
    return(
        <div className="text-center text-[#486D37] my-7 ">
            ...
            <div className="border-r border-[rgb(72,109,55)]">
                <h1 className="text-3xl md:text-6xl">70+</h1>
                <p className="text-sm">Various house models</p>
            </div>
            <div className="md:border-r border-[rgb(72,109,55)]">
                <h1 className="text-3xl md:text-6xl">10+</h1>
                <p className="text-sm">convenience stores</p>
            </div>
            <div className="hidden md:block">
                <h1 className="text-3xl md:text-6xl">5+</h1>
            ...
            <div className="border-r border-[#486D37]">
                <h1 className="text-3xl md:text-6xl">15+</h1>
                <p className="text-sm">Minute to city</p>
            </div>
            <div className="md:border-r border-[#486D37]">
                <h1 className="text-3xl md:text-6xl">130+</h1>
                <p className="text-sm">Various house plant</p>
            </div>
            <div className="hidden md:block">
                <h1 className="text-3xl md:text-6xl">19+</h1>
                <p className="text-sm">Hand and outlet institutions</p>
            </div>
            </div>
        </div>
    )
